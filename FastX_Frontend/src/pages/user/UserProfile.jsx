...
const UserProfile = () => {
    ...
    if (loading) {
        return <UserLayout><p className="text-muted">Loading profile...</p></UserLayout>;
    }
                ...
                <Col md={4}>
                    <Card style={{ textAlign: "center" }}>
                        <Card.Body style={{ padding: "32px 24px" }}>
                            ...
                            <Badge bg="primary" style={{ marginBottom: 20 }}>Passenger</Badge>
                            ...
                            <div style={{ textAlign: "left", borderTop: "1px solid #e2e8f0", paddingTop: 20, marginBottom: 20 }}>
                                {[
                                    ...
                                    <div key={item.label} style={{ display: "flex", gap: 12, marginBottom: 14, alignItems: "flex-start" }}>
                                        <div style={{ width: 32, height: 32, background: "#eef2ff", borderRadius: 8, display: "flex", alignItems: "center", justifyContent: "center", color: "#4f46e5", fontSize: "0.8rem", flexShrink: 0 }}>
                                            {item.icon}
                                        </div>
                                        <div>
